...
jQuery(function ($) {
  ...
  if ($(".section-custom-bg").length) {
    $(".section-custom-bg").each(function () {
      ...
      var bg_img = "uploads/myslide1.jpeg",
        bg_color = "#000000",
        bg_opacity = "0.5",
        bg_color_2 = "#000000",
        bg_opacity_2 = "0.8",
  ...
  if ($("#countdown_block").length > 0) {
    $("#countdown_block").countdown("2023/02/26", function (event) {
      var $this = $(this).html(
        event.strftime(
          "" +
    ...
    $contact_form.find("button[type=submit]").on("click", function () {
      ...
      if ($user_name.val() === "") {
        ...
        $user_name
          ...
          .after(
            "<span class='error'>" + $user_name.attr("data-msg") + "</span>"
          );
      } else {
      ...
      if (
        ...
        $user_email
          .attr("style", $error_border)
          .after(
            "<span class='error'>" + $user_email.attr("data-msg") + "</span>"
          );
      } else {
      ...
      if ($email_subject.val() === "") {
        ...
        $email_subject
          .attr("style", $error_border)
          .after(
            "<span class='error'>" + $email_subject.attr("data-msg") + "</span>"
          );
      } else {
      ...
      if ($email_message.val() === "") {
        ...
        $email_message
          .attr("style", $error_border)
          .after(
            "<span class='error'>" + $email_message.attr("data-msg") + "</span>"
          );
      } else {
